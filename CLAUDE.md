...
```bash
ssh millennium@millennium-phone.local
```
...
./Arduino/deploy_display.sh [millennium@millennium-phone.local]
./Arduino/deploy_keypad.sh  [millennium@millennium-phone.local]
```
