...
reverse-tunnel process to remain active beyond four 30-second keepalive
boundaries (125 seconds). The current signed application release establishes each MCU's
