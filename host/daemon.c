 ...
 *
 * The actual command parsing/dispatch lives in control_commands.c (#248) so
 * it can be linked into the simulator and unit tests directly, instead of
 * being hand-mirrored there. */
